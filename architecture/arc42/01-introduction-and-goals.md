...
| --- | --- | --- |
| G-01 | Give each durable fact one canonical owner and use references or controlled projections elsewhere. | AP-001; ADR-0012, ADR-0013, ADR-0018, ADR-0020; recovery issue [#59](https://github.com/agentic-delivery-lab/agentic-delivery/issues/59). |
...
| --- | --- | --- |
| 1 | Correct ownership and traceability | Every ADR referenced by a pinned Primitive catalog resolves to exactly one local Architecture record; external text projections are forbidden. |
