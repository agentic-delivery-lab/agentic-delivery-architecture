...
const requiredCoverage = new Map([
  ...
  ['05-building-block-view.arc42.md', ['Canonical owner', 'Agentic Primitives', 'Developer Distribution', 'GitHub App', 'adr-owner-projection.yml']],
  ...
  ['09-architecture-decisions.arc42.md', ['ADR-0001', 'ADR-0019', 'ADP-0001', 'ADD-0001', 'adr-owner-projection.yml']],
  ['10-quality-requirements.arc42.md', ['QR-001', 'QR-003', 'QR-004', 'QR-005', 'QR-007', 'QR-008', 'QR-010', 'quality-scenarios.yml']],
